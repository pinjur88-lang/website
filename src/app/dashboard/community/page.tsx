...
import { MessageSquare, User, Send, Shield, Search, PlusCircle, Crown, Heart, Star, Award } from 'lucide-react';
...
const CommentCounter = ({ postId, suffix }: { postId: string, suffix: string }) => {
    ...
    return <span className="text-xs text-stone-500 font-medium">{count} {suffix}</span>;
};
